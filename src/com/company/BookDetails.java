...
public class BookDetails extends JFrame implements ActionListener
{
    ...
    public BookDetails()
    {
        ...
        JLabel l1 = new JLabel("Kitap Detayı");
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 128, 128), 3, true), "Kitap Detayı",
    ...
    public void actionPerformed(ActionEvent e)
    {
        try{
            ...
            if(e.getSource() == b1){
                ...
                String sql = "select * from Kitap where concat(isim, kitap_Id) like ?";
                PreparedStatement st = con.c.prepareStatement(sql);
            ...
            if(e.getSource() == b2){
                String sql = "delete from Kitap where isim = '" + search.getText() + "'";
                PreparedStatement st = con.c.prepareStatement(sql);

                JDialog.setDefaultLookAndFeelDecorated(true);
                int response = JOptionPane.showConfirmDialog(null, "Devam Etmek İstiyor musunuz?", "Evet",
